...
class LoanBroker_test : public beast::unit_test::Suite
{
    ...
    // even if they are set to unsupported. featureLendingProtocolV1_1 is
    // excluded because VaultCreate rejects open-ended vaults under that
    // amendment, and this suite's happy-path helpers still create
    // open-ended vaults. Tests that exercise LP V1.1 opt in explicitly.
